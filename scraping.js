...
(function example() { 
    ...
    //         const item = line.substr(line.lastIndexOf(",")+1,line.lastIndexOf(",")+10) 
    ...
    //         await driver.get('http://www.smv.gob.pe/Frm_LisDatosGenerales?data=B5C77F8C6BF989E2D2220F8ED366A4EF1CB0260F56').then(async ()=>{ 
    ...
    //           const company = await driver.findElement(By.id("MainContent_cboDenominacionSocial")).sendKeys(item).then(()=>{ 
